...
export const companyHistoryTool: ToolPluginToolDefinition<
  { apiBaseUrl: string; sharedSecret: string },
  typeof CompanyHistoryParams
> = {
  name: "gktrader_company_history",
  label: "Company Signal History",
  description:
    "Fetch all prior bullish signals for a company/ticker. Returns ticker, signal list with source date, event type, alert level, and rationale. Used for bearish-alert pre-history and company context queries.",
