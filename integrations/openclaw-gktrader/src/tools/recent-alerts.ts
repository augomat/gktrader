...
export const recentAlertsTool: ToolPluginToolDefinition<
  { apiBaseUrl: string; sharedSecret: string },
  typeof RecentAlertsParams
> = {
  name: "gktrader_recent_alerts",
  label: "Recent GKTrader Alerts",
  description:
    "Fetch the most recent GKTrader alerts (up to 50). Returns alert ID, level, and rendered payload for each.",
