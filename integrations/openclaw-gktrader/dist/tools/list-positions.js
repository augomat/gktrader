...
export const listPositionsTool = {
    ...
    description: "List all current projected positions with ticker, direction, net amount (EUR), average price, and last-updated timestamp.",
...
//# sourceMappingURL=list-positions.js.map