...
export const recordDecisionTool = {
    ...
    description: "Record a trade decision (bought, sold_reduced, shorted, or no_trade) against a GKTrader alert. " +
    ...
    async execute(params, config, _context) {
        ...
        const result = await client.recordAlertDecision(params.alert_id, {
...
//# sourceMappingURL=record-decision.js.map