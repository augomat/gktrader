...
export const recordPositionEventTool = {
    name: "gktrader_record_position_event",
    label: "Record Position Event",
    description: "Record a manual position event (open, increase, reduce, close, confirm, adjust) for a ticker. " +
...
//# sourceMappingURL=record-position-event.js.map